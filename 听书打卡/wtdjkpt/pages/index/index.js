...
Page({
    ...
    suspension: function() {
      console.log(getApp().api.default.buy_data,'测试');
        var o = this;
    ...
    loadData: function() {
      ...
      console.log(this.data.user_info_show,'where');
            ...
            success: function(t) {
                if (0 == t.code) {
                    if ("diy" == t.data.status) {
                      ...
                      console.log(i.data.user_info_show,'____________');
                    page_first_init ? i.data.user_info_show || (page_first_init = !1) : t.data.act_modal_list = [], 
