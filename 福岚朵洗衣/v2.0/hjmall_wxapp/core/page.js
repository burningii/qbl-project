module.exports = {
    ...
    setPageNavbar: function (s) {
        ...
        function n(e) {
            ...
            // t && (loadNavbarByRole(), c.setPageClasses());

            function loadNavbarByRole() {
                let userAccessToken = wx.getStorageSync('ACCESS_TOKEN');
                userAccessToken && getApp().request({
                    url: getApp().api.user.result,
                    success: res=>{
                        if (1==res.data.part_id || 3==res.data.part_id){
                            console.log('CIA当然');
                            console.log(e);
                            let _navbar = e;
        ...
        getApp().core.showLoading({
            ...
            success: function (e) {
                if (0 == e.code) {
                    ...
                    console.log(wx.getStorageSync('USER_INFO').verify);
                    n.currentPage.loadData()
