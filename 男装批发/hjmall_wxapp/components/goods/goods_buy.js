module.exports = {
    ...
    submit: function (t) {
        ...
        var e = a.data.attr_group_list.filter(item => {
        ...
        const attrGroupList = a.data.attr_group_list[0].attr_list
        const latestNum = a.data.goods.start_sale_count
        let totalNum = 0
                ...
                if (item.list.length > 0) {
                    item.list.forEach((item2, index) => {
                        d.push({
                            ...
                            num: item2.attr_num,
                            attr: [{
                                attr_group_id: a.data.attr_group_list[0].attr_group_id,
                                attr_id: item.group_id
                            }, {
                                attr_group_id: a.data.attr_group_list[1].attr_group_id,
