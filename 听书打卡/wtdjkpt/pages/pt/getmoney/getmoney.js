...
Page({
  ...
  init() {
    ...
    getApp().request({
      ...
      success: res => {
        _that.setData({
          price: res.data.user_info.money
        })
      }
    })
  },
  pickerEvent(e){
    ...
    e.detail.value==0?this.setData({selected:1}):e.detail.value==1?this.setData({selected:2}):this.setData({selected:3});
    this.setData({
      idx:e.detail.value
    })
  },
    ...
    if (a) if (i < a) getApp().core.showToast({
      ...
      if (0 == o || 1 == o || 2 == o || 3 == o || 4 == o) {
        ...
        getApp().core.showLoading({
          ...
          url: getApp().api.default.withdraw,
          method: "POST",
          data: {
            cash_val: a,
            nickname: c,
