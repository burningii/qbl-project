...
Page({
            ...
            if ('0' == data.err_code) {
                ...
                if (null==resultList){
                    ...
                    for (let item of newArr) {
                        if (1 == item.houseState) item.statusTxt = '终审已通过'
                        if (2 == item.houseState) item.statusTxt = '未审批'
                        if (3 == item.houseState) item.statusTxt = '初审已通过'
    ...
    goInfo(e) {
        wx.navigateTo({
            url: `/pages/landlord/page2/info/info?data=${JSON.stringify(e.currentTarget.dataset.item)}`
        })
    },
    ...
    reloadSubmit(e){
        wx.navigateTo({
          url: `/pages/landlord/page1/page1?info=${JSON.stringify(e.currentTarget.dataset.item)}`
        })
    },
