...
var api = {
    ...
    default: {
        ...
        goods_attrs_info: _api_root + "default/goods-attrs-info",
        ...
        edit_pass: _api_root + "default/edit-pass",
    },
    cart: {
    ...
    part: {
        role: _api_root+"part/role"
    },
    logist:{
        codes: _api_root+'logist/codes',
        logistics: _api_root+"logist/logistics",
        queen: _api_root+"logist/queen",
        cuation: _api_root+"logist/cuation",
        charge: _api_root+"logist/charge",
        cuten: _api_root+"logist/cuten",
        shape: _api_root+"logist/shape",
        shapes: _api_root+"logist/shapes",
        san: _api_root+"logist/san",
        problem: _api_root+"logist/problem",
        factory: _api_root+"logist/factory",
        done: _api_root+"logist/done",
        bcode: _api_root+"logist/bcode",
        figure: _api_root+"logist/figure",
        search: _api_root+"logist/search",
        orderf: _api_root+"logist/orderf",
        order: _api_root+"logist/order",
        corder: _api_root+"logist/corder",
        printorder: _api_root+"logist/porder",
        forder: _api_root+"logist/forder",
        forders: _api_root+"logist/forders",
        torder: _api_root+"logist/torder",
        cash: _api_root+"logist/cash",
        refund: _api_root+"logist/refund",
        draw: _api_root+"logist/draw",
        imges: _api_root+"logist/imges",
        images: _api_root+"logist/images",
        account: _api_root+"logist/account",
        detailed: _api_root+"logist/detailed",
        logdet: _api_root+"logist/logdet",
    },
    share: {
