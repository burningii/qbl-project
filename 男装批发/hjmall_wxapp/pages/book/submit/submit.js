...
Page({
    ...
    onLoad: function(t) {
        t.attr_list && this.setData({
            attr_group_list: JSON.parse(t.attr_list)
        })
    ...
    getPreview: function(t) {
        console.log('---参数传递---',JSON.parse(t.goods_info));
    ...
    submit: function(t) {
        ...
        const checkedAttrList = this.data.attr
        const d = [];
                ...
                item.list.forEach((item2, index) => {
                    d.push({
                        ...
                        attr: [{
                            ...
                            attr_group_id: this.data.attr_group_list[1].attr_group_id,
