...
Page({
  ...
  init(e){
    ...
    getApp().request({
      ...
      success: res => {
        if(res.data.length==0) {wx.showModal({
          title: '提示',
          content: '没有更多了',
        })
        return;
        ...
        console.log(res);
       var a=new Date(Number(res.data[0].created_at) * 1000);
