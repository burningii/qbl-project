...
Page({
    ...
    onInputShape(e) {
        ...
        shapeList[index].value = e.detail
        this.setData({
            shapeList
        })
    },
    ...
    onLoad: function (t) {
        ...
        o.setData({
            id: t.id
        }), o.getGoods(), o.getCommentList(),o.getShapeCate();
    },
    // 获取条形码阶段
    getShapeCate(){
        wx.showLoading({
            ...
            success: function (t) {
                if (0 == t.code) {
                    ...
                    e.pic_list = i, n.setData({
                        ...
                        attr_group_lists: t.data.attr_group_lists,
                        btn: !0
                    }), n.goods_recommend({
                        goods_id: t.data.id,
                        reload: !0
