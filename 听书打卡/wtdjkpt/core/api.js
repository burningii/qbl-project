...
var api = {
    ...
    default: {
      withdraw_log: _api_root +'user/withdraw_log',
      withdraw:_api_root+'user/withdraw',
      get_articles:_api_root+'course/course_articles',
      get_mycourse:_api_root+'course/get_course',
      my_course:_api_root+'course/my_courses',
      get_course:_api_root+'common/get_course_goods',
      answer:_api_root+'qa/answer',
      upload_audio:_api_root+'default/audio',
      upload_video:_api_root+'default/video',
      userQue:_api_root+'qa/my_questions',
      expertQue:_api_root+'qa/my_cases',
      ask:_api_root+'qa/ask',
      get_artificers:_api_root+'common/get_artificers',
      get_cates:_api_root+'common/get_cates',
      subjects:_api_root+'common/get_subjects',
        arti_register:_api_root+'artificer/arti_register',
        get_artificer:_api_root+'common/get_artificer',
        skills: _api_root + "common/get_skills",
    ...
    course: {
        clock: _api_root+"course/clock",
        set_record: _api_root+"course/set_record",
    },
    order: {
    ...
    diy:{
      arti_edit: _api_root + 'artificer/arti_edit',
    }
};
