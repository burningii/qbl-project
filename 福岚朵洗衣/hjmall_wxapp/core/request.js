module.exports = function(a) {
    ...
    t && 1 <= t.length && s.is_form_id_request && (s.is_form_id_request = !1, s.request({
        ...
        success: function(e) {
          // -1 == e.data.code ? (s.core.hideLoading(), a.url.indexOf('api/share/index') == -1 ? s.page.navtoSignPage():'', s.is_login = !1) : -2 == e.data.code ? o.redirectTo({
          ...
          //   }) : a.success && a.success(e.data);
            ...
            if (-1==e.data.code){
                s.core.hideLoading()
                if (a.url.indexOf('api/user/index') != -1){
                    a.success && a.success(e.data);
                }else if (a.url.indexOf('api/share/index') == -1){
                    s.page.navtoSignPage()
                }
