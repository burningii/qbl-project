...
Page({
    data: {
        ...
        show_customer_service: 0,
                       bg_url:'https://dev.qibuluo.net/addons/zjhj_mall/core/web/statics/images/user-center/img-user-bg.png',
  ...
  login(){
    ...
    orderEvent(){
      wx.navigateTo({
        url: '/pages/orderClassify/orderClassify',
      })
    },
  artificerOrder(){
    wx.navigateTo({
      url: '/pages/artificerOrder/artificerOrder',
    })
  },
  artificerOrderRecord(){
    wx.navigateTo({
      url: '/pages/artificerOrderRecord/artificerOrderRecord',
    })
  },
    onReady: function(e) {
