                ...
                getApp().core.showLoading({
                    ...
                    success: function (e) {
                        ...
                        if (0 == e.code) {
                            ...
                            const zbId = e.data.order_id_list ? JSON.stringify(e.data.order_id_list) : ''
                            0 == r.payment ? app.request({
                                ...
                                success: function (e) {
                                    ...
                                    if (0 != e.code) {
                                        ...
                                        function showQrCode() {
                                            console.log(d);
                                            console.log(e.data.new_total_price);
                                            app.request({
                                                url: app.api.logist.forders,
                                                method: 'POST',
                                                data: {
                                                    order_id: zbId,
                                                    money: _.page.data.new_total_price
                                                },
                                                success: res2 => {
                                                    if (0 == res2.code) {
                                                        _.page.setData({
