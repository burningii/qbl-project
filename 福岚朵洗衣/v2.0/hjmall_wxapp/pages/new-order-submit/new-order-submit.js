...
Page({
    ...
    buinnesPay(){
        wx.navigateTo({
          url: `/pages/new-order-submit/buinnes-pay?order_id_list=${this.data.orderIdList}&parent_id=${this.data.my_parent_user_id}&price=${this.data.new_total_price}`
        })
    },
    // 提交按钮
    orderSubmit: function (t) {
        ...
        1 == e.data.integral_radio ? a.use_integral = 1 : a.use_integral = 2, a.payment = e.data.payment,
            a.formId = t.detail.formId,console.log('a的值为: ', a),this.setData({pay_options: a}), e.order_submit(a, "s");
    },
    onReady: function () {
    },
    onShow: function (t) {
    ...
    getOrderData: function (t) {
        var _ = this, e = {}, a = "", customPhone = wx.getStorageSync('customPhone');
        ;
